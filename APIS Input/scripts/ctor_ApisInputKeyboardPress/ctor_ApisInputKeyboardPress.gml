function ApisInputKeyboardPress(_key, _modifiers = undefined, _groupid = undefined, _priority = undefined) : ApisInputPress(_groupid, _priority) constructor {
    key = to_keycode(_key);
    ...
    if (is_undefined(_groupid)) {
        ...
        priority = _priority ?? array_length(modifiers);
    }
